...
/**
 * Changes the name of an uploaded attachment.
 * Forces save name so it won't break between environments
 */
function media_sanitize_names_to_latin( $filename ) {
  $chars_table = array(
    // Cyrillic alphabet
    '/А/' => 'a', '/Б/' => 'b', '/В/' => 'v', '/Г/' => 'g', '/Д/' => 'd',
    '/а/' => 'a', '/б/' => 'b', '/в/' => 'v', '/г/' => 'g', '/д/' => 'd',
...
add_filter( 'sanitize_file_name', 'media_sanitize_names_to_latin', 10 );
